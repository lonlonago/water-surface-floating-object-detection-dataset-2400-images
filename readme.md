# Water surface floating object detection dataset 2400 images.

# Body

Water Surface Floating Objects Detection Dataset, 2400 images
suitable for learning and research.
Content comprehensive, directory clear, supports YOLO, VOC formats.
Sold as seconds， .

Part of the original description was in Chinese and has been omitted.
Grass —— grass
branch —— Branch
Milk-box —— Milk box / Milk carton
Part of the original description was in Chinese and has been omitted.
Plastic-garbage —— plastic waste
Part of the original description was in Chinese and has been omitted.
Leaf —— leaf
